...
excerpt:  Мок - це не чудодійний засіб для тестування. Чудодійний засіб для тестування - це JUnit, Selenium або testcontainers. А от мок - це необхідне зло. Іноді без них не обійтися. Але якщо можна без них обійтися, то краще обходитися. Уникайте моків. 
---
