...
exts:
  ...
  - https://drukarnia.com.ua/articles/shumerski-zaklyattya-dosZr
excerpt:
...
В сучасності поміж поважними шумерологами древні закляття не користуються популярністю. Їм відмовляють у художній та історичній цінності та їх досить рідко досліджують. Наприклад на порталі з шумерською літературою ETCSL вони взагалі не представлені. 

Відповідно, шумерські закляття часто пропускають при огляді шумерської літератури. А оскільки в аккадській літературі закляття складно проігнорувати, то може скластися враження, що шумерам закляття були непритаманні взагалі і що з'явилися вони вже пізніше. Хоча два шумерські закляття на українську переклав ще Іван Франко, а ще одне закляття ("Благородна діва") переклав Москаленко. На щастя, дослідники повністю не оминули увагою шумерські закляття, хоча знайти по них інформацію значно складніше.

Длі цієї статті я обрав декілька коротких заклинань надаючи перевагу найстаршим із них. А в наступній статті буде переклад довшого заклинання, або радше – набору заклинань, зі значно пізнішого періоду. І хоча між цими текстами пройшли сотні, а то й тисяча років, схожість буде очевидною.
...
В оригіналі вживається не ім'я Асалухі, а скорочена форма імені "Асар". Імена шумерських богів часто мають декілька синонімів. Слів виділених курсивом в оригіналі нема, вони додані для кращого розуміння тексту.
...
Про Енкі ми вже говорили раніше. Тут він згадується без прив'язки до Асалухі, а більше за його прямою функцією – він був богом Вічних Вод (Абзу) та рік.
